...
def _get_test_and_reports_dir() -> Tuple[str, str]:
    """
    Get the directory that holds the tests and the directory to write reports to.
    If the directory to write reports to isn't present, it is created.

    Returns
    -------
    str: The directory the tests are situated in
    str: The directory to write reports to
    """
...
def _get_parsed_args(test_dir: str) -> Tuple[bool, bool, str, str]:
    ...
    Returns
    -------
    bool: If true report coverage as coverage.xml in the reports directory
    bool: If true report test unit results as junit xmls in the reports directory
    str: The location of the test files or file to run e.g. script_tests or test_bands_data.py
    str: Only run the specified markers e.g. "unit" or "unit or integration"
    """
...
def _build_pytest_options(reports_dir: str, do_report_tests: bool, tests: str,
    ...
    markers : Union[str, None]
        The markers for pytest tests to run e.g. "unit" or "unit or integration"
...
if __name__ == "__main__":
    ...
    pytest_options: List[str] = _build_pytest_options(reports_dir, do_report_tests,
                                                      tests, markers_to_run)
