...
class TestReadNaClPhononQPoints(unittest.TestCase):
    ...
    def setUp(self):
        self.path = os.path.join(
            get_data_path(), 'phonopy_data', 'NaCl', 'qpoints')
    ...
    def test_weights_read_nacl_phonon(self):
        npt.assert_array_equal(self.data.weights, self.expctd_data.weights)
    ...
    def test_eigenvecs_read_nacl_phonon(self):
        npt.assert_array_equal(self.data.eigenvecs, self.expctd_data.eigenvecs)
