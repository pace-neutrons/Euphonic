...
:math:`\alpha` runs over the Cartesian directions, :math:`a` runs over unit
cells in the supercell, :math:`u_{\kappa, \alpha}` is the displacement of atom
...
in the supercell, :math:`\epsilon_{q\nu\kappa\alpha}` are the eigevectors, and
