            ...
            if (isUnix()) {
                sh """
                    ...
                    --data '{ \
                        ...
                        "context": "continuous-integration/jenkins/${env.JOB_BASE_NAME}/${context}" \
                    }' \
                ...
                bat """
                    ...
                    set DATA="{'state': '${status}', 'description': '${context}: ${message}', 'target_url': '$BUILD_URL', 'context': 'continuous-integration/jenkins/${env.JOB_BASE_NAME}/${context}'}"
