...
def subtract_fc_dipole(force_constants: Quantity, crystal: 'Crystal',
                       sc_matrix: np.ndarray, cell_origins: np.ndarray,
                       born: Quantity, dielectric: Quantity) -> Quantity:
    """
    ...
    short_range_fc
        Shape (n_cells_in_sc, 3*n_atoms, 3*n_atoms) float Quantity
        in energy/length**2 units. The short-ranged force constants
        matrix.
    """
